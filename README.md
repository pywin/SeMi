...
Long-tail (LT) splits can be generated by provided scripts (if included) or you can supply your own list files.  
Update dataset paths in `configs/data/*.yaml` or via CLI (see below).
